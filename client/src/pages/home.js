    ...
    <Card style={{ maxWidth: "36rem", minWidth: "18rem" }}>
      <Container>
        ...
        <Card.Body>
          <Card.Text>
            <p>
              Bankify is the banking solution for you! With local branches
              across the United States, we serve our customers with services
              like: withdraw, deposit, balances, and hack the system.
            </p>
            <p>
